<template>
    <DefaultLayout>
        ...
        <h2 class="text-center mt-3">Listado de Libros y Capítulos</h2>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Eliminar libro/capítulo</h5>
                        <button type="button" class="btn-close" aria-label="Close" @click="cerrarModalEliminar()"></button>
                    </div>
                    <div class="modal-body">
                        <p>¿Está seguro que desea eliminar el libro/capítulo '{{ modalEliminar.nombre }}'?</p>
                    </div>
        ...
        <div class="container" v-if="!loading">
            <div class="d-flex align-items-center mt-4">
                ...
                <div class="alert alert-success mx-auto p-2" v-if="exitoEliminar">Libro/Capítulo(s) '{{ modalEliminar.nombre
