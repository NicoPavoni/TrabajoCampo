    ...
    <DefaultLayout>
        <div class="container d-flex flex-column mt-5" v-if="!loading">
            ...
            <div class="d-flex flex-column  flex-md-row justify-content-center">
                <div class="mb-3 me-3">
                    <label for="nombreDocumento" class="form-label fw-bold">Nombre del Documento</label>
                    <input v-model="documento.nombre" type="text" class="form-control" id="nombreDocumento"
                        placeholder="Nombre" required disabled>
                </div>

                <div class="mb-3 me-3">
                    <label for="lugar" class="form-label fw-bold">Lugar</label>
                    <input v-model="documento.documento_tecnico.lugar" type="text" class="form-control" id="lugar"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input v-model="documento.documento_tecnico.fecha" type="date" class="form-control" id="fecha"
            ...
            <div class="overflow-auto mb-4 mt-3" v-if="documento.autores.length > 0">
                ...
                <table class="table mx-auto text-center">
                    ...
                    <tbody>
                        <tr v-for="autor in documento.autores" :key="autor.id">
                            <td>{{ autor.nombre }}</td>
                            <td>
                                {{ autor.apellido }}
                            </td>
