    ...
    <form @submit="crearDocumentoTecnico">
      <div class="container d-flex flex-column mt-5" v-if="!loadingAutores">
        ...
        <div class="d-flex flex-column  flex-md-row justify-content-center">
          <div class="mb-3 me-3">
            ...
            <input v-model="documento.nombre" type="text" class="form-control" id="nombreDocumento" placeholder="Nombre"
              required>
          </div>
      ...
      <div class="d-flex justify-content-center  mb-5 mt-3">
        ...
        <button type="submit" class="btn btn-success" :disabled="loading">
          ...
          <i class="bi bi-plus me-1" :class="{ 'd-none': loading }"></i>Crear Documento
        </button>
      </div>
    </form>
...
export default {
  ...
  methods: {
    crearDocumentoTecnico: async function (e) {
      e.preventDefault();
      this.errors = {
        "tipo_doc_tecnico": null,
        "autores": null
      ...
      if (this.documento.tipo_doc_tecnico === null) {
      ...
      this.loading = true;
      await this.docStore.crearDocTecnico(this.documento)
