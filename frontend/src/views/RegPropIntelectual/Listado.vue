<template>
    <DefaultLayout>
        ...
        <h2 class="text-center mt-3">Listado de Registros de Propiedad Intelectuales</h2>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Eliminar registro de propiedad intelectual</h5>
                        <button type="button" class="btn-close" aria-label="Close" @click="cerrarModalEliminar()"></button>
                    </div>
                    <div class="modal-body">
                        <p>¿Estas seguro que desea eliminar el registro '{{ modalEliminar.nombre }}'?</p>
                    </div>
        ...
        <div class="container" v-if="!loading">
            <div class="d-flex align-items-center mt-4">
                <router-link to="/registro-propiedad-intelectual/alta" class="text-center btn btn-success"><i
                        class="bi bi-plus-lg me-2"></i>Nuevo</router-link>

                <div class="alert alert-success mx-auto p-2" v-if="exitoEliminar">Registro de Propiedad Intelectual '{{
                ...
                <table class="table mx-auto text-center">
                    ...
                    <tbody>
                        <tr v-for=" registro  in  registros " :key="registro.id">
                            ...
                            <td>{{ registro.tipo_licencia.nombre }}</td>
...
const verDetalles = (registroId) => {
    router.push("/registro-propiedad-intelectual/" + registroId);
};
const editarRegistro = (registroId) => {
    router.push("/registro-propiedad-intelectual/" + registroId + "/editar");
}
</script>
...
export default {
    async mounted() {
        ...
        await registroStore.listarRegPropIntelectuales()
    ...
    methods: {
        async eliminarRegistro(registroId) {
            ...
            await this.registroStore.eliminarRegPropIntelectual(registroId)
                .catch(e => console.error(e))
                .then(data => {
                    if (data.status == 200) {
